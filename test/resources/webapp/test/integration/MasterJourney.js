sap.ui.define([
		...
		opaTest("MasterList Filtering on id less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("id").
		...
		opaTest("MasterList Filtering on id more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 ").
				and.iPressOKInViewSelectionDialog();
