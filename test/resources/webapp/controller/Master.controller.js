/*global history */
sap.ui.define([
		"rtrt/controller/BaseController",
		...
		return BaseController.extend("rtrt.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("usern", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("rtrt.view.ViewSettingsDialog", this);
