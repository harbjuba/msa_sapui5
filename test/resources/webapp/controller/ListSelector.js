sap.ui.define([
		...
		return BaseObject.extend("rtrt.model.ListSelector", {
			 ...
			 * @return {rtrt.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
