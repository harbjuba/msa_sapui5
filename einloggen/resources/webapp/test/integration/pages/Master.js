							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("YRHEINLOGGEN_TSet", {
											Id : sCurrentId
										});
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "YRHEINLOGGEN_TSet (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'YRHEINLOGGEN_TSet (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all YRHEINLOGGEN_TSet to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "YRHEINLOGGEN_TSet (" + iExpectedLength + ")"}),
									success : function () {
